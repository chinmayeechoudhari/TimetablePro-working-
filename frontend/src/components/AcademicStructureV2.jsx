...
export default function AcademicStructureV2() {
  ...
  async function create(e) {
    ...
    try {
      ...
      setMessage(response.data.message); setCounts({1:0,2:0,3:0,4:0}); setDepartment(''); closeModal(); await load()
  ...
  async function deleteLegacy() {
    ...
    try {
      ...
      await load()
    } catch (e) { setError(e.response?.data?.detail || 'Could not delete legacy class.') }
  }

  return <div className="academic-page">
    <section className="academic-hero">
      <div className="hero-copy"><div className="academic-eyebrow">ACADEMIC SCHEDULING</div><h1>Academic Structure</h1><p>Set up departments, years and divisions before subjects, faculty assignments and timetable generation.</p></div>
